...
arguments-hint: "Provide a CV/résumé, a job level, or ask for interview questions (e.g. 'review this CV for a Mid BA role', 'generate Senior BA interview questions')"
tools:
  - Read
  - Write
  - Edit
...
1. **Load the question bank first** — read the relevant file(s) from `.claude/skills/ba-interview-questions/` (`CORE-SKILLS.md`, `SOFT-SKILLS.md`, `TECH-SKILLS.md`) based on the skill area being assessed
...
The question bank is split into separate files — load the relevant file(s) from `.claude/skills/ba-interview-questions/` depending on the skill area being assessed:
- `CORE-SKILLS.md` — core BA competencies (elicitation, analysis, documentation, agile)
- `SOFT-SKILLS.md` — soft skills and interpersonal competencies
- `TECH-SKILLS.md` — technical skills (API, data, integration, AI)
- `SITUATIONAL-SCENARIOS.md` — scenario-based and situational questions

Each file contains questions with Assessing / Green / Red signals and seniority tags (J/M/S/All).
