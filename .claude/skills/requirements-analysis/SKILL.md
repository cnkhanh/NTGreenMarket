...
description: Analyzes and refines requirements, validates against SMART criteria, and identifies gaps, risks, and dependencies. Use for requirement analysis and validation.
---
...
## When to Use
- Performing structured requirement analysis tasks
- Validating and refining software requirements
- Conducting impact analysis or feasibility studies
- Ensuring requirements meet SMART criteria

## Prerequisites
- List of requirements (functional and/or non-functional)
- Draft solution or design outline (optional)
...
Analyze, validate, and refine software requirements into implementable, SMART-aligned, and user-centric solutions while following the BA core principles.
